        ...
        snap.forEach(docSnap => {
            ...
            if (t.userId === uid) {
                ...
                ticketCard.style.cssText = `
                    ...
                    filter: ${isScanned ? 'grayscale(1) opacity(0.7)' : 'drop-shadow(0 15px 30px rgba(0,0,0,0.2))'};
                `;
    ...
    <svg viewBox="0 0 600 260" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:auto; display:block;">
        ...
        <foreignObject x="0" y="0" width="415" height="260">
            <div xmlns="http://www.w3.org/1999/xhtml" style="height:100%; padding:25px 30px; color:white; display:flex; flex-direction:column; justify-content:center; box-sizing:border-box; font-family:sans-serif; position:relative;">
                ...
                ${isScanned ? `<div style="position:absolute; top:50%; left:50%; transform:translate(-50%, -50%) rotate(-15deg); border:4px solid rgba(255,255,255,0.2); padding:10px 20px; font-size:40px; font-weight:900; color:rgba(255,255,255,0.2); z-index:10; pointer-events:none; border-radius:10px;">КОЛДОНУЛДУ</div>` : ''}
                ...
                <div style="display:flex; align-items:center; gap:10px; margin-bottom:10px;">
                    ...
                    <span style="font-size:16px; font-weight:800; color:${statusColor}; letter-spacing:1.5px; text-transform:uppercase;">
                        ${isScanned ? "ЖАРАКСЫЗ" : (isApproved ? "ДАЯР" : "КҮТҮҮДӨ")}
                    </span>
                </div>
                
                <h2 style="margin:0 0 20px 0; font-size:36px; font-weight:900; line-height:1; letter-spacing:0.5px; overflow:hidden; white-space:nowrap; text-overflow:ellipsis; ${isScanned ? 'text-decoration: line-through;' : ''}">
        ...
        <foreignObject x="415" y="0" width="185" height="260">
            <div xmlns="http://www.w3.org/1999/xhtml" style="height:100%; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:15px; box-sizing:border-box;">
                <div id="qr-${id}" style="line-height:0; padding:8px; background:white; border-radius:10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); display:flex; align-items:center; justify-content:center;">
                    ${isScanned ? 
                        `<div style="width:110px; height:110px; display:flex; align-items:center; justify-content:center; color:#ff4757; flex-direction:column;">
                            <span class="material-icons-round" style="font-size:50px;">block</span>
                            <span style="font-size:10px; font-weight:900; margin-top:5px;">ЖАРАКСЫЗ</span>
                         </div>` : 
...
`;
                ...
                // QR кодду түзүү (Эгер статус жалаң 'approved' болсо гана)
                if (isApproved && !isScanned) {
                    setTimeout(() => {
