...
window.handleAtknSubmit = async (e) => {
    ...
    try {
        ...
        await addDoc(collection(db, "user_tickets"), {
            ...
            count: adults + children, // Билетте сандар көрүнүшү үчүн
    ...
    onSnapshot(collection(db, "user_tickets"), (snap) => {
        ...
        snap.forEach(docSnap => {
            ...
            if (t.userId === uid) {
                ...
                // Сиз айткан жаңы статус: checked-in
                const isCheckedIn = t.status === 'checked-in';
                
                // Түстөр жана статустар
    ...
    <svg viewBox="0 0 600 260" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:auto; display:block;">
        ...
        <foreignObject x="0" y="0" width="415" height="260">
            <div xmlns="http://www.w3.org/1999/xhtml" style="height:100%; padding:25px 30px; color:white; display:flex; flex-direction:column; justify-content:center; box-sizing:border-box; font-family:sans-serif; position:relative;">
                ...
                ${isCheckedIn ? `<div style="position:absolute; top:50%; left:50%; transform:translate(-50%, -50%) rotate(-15deg); border:4px solid #ff4757; padding:10px 20px; font-size:35px; font-weight:900; color:#ff4757; z-index:10; border-radius:10px; text-transform:uppercase; background:rgba(0,0,0,0.1);">ТЕКШЕРИЛДИ</div>` : ''}
                ...
                <div style="display:flex; justify-content: space-between; gap:15px;">
                    <div style="flex: 2;">
                        <p style="margin:0; font-size:15px; color:#94a3b8; font-weight:700;">ЭЭСИ</p>
                        <p style="margin:6px 0; font-size:20px; font-weight:700;">${t.userName}</p>
                    </div>
                    <div style="flex: 1.4;">
                        <p style="margin:0; font-size:15px; color:#94a3b8; font-weight:700;">УБАКТЫСЫ</p>
                        <p style="margin:6px 0; font-size:20px; font-weight:800; color:#e6d8b5;">${t.sessionTime}</p>
                    </div>
                    <div style="flex: 1;">
                        <p style="margin:0; font-size:15px; color:#94a3b8; font-weight:700;">САНЫ</p>
        ...
        <foreignObject x="415" y="0" width="185" height="260">
            <div xmlns="http://www.w3.org/1999/xhtml" style="height:100%; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:15px; box-sizing:border-box;">
                <div id="qr-${id}" style="width:130px; height:130px; background:white; border-radius:10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); display:flex; align-items:center; justify-content:center; overflow:hidden;">
                    ${isCheckedIn ? 
...
`;
                ...
                // QR кодду түзүү (Билет checked-in эмес болсо гана)
